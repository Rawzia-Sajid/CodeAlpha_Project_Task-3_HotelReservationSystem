...
// Establish connection with the MySQL database
            ...
            ResultSet rs = st.executeQuery("select * from rooms_notlogin");
            ...
            while (rs.next()) {
                ...
                model = (DefaultTableModel) tblBookingroom.getModel();
                model.addRow(obj);
    ...
    private void handleBookNow() {
        if (isLoggedIn) {
            // User is logged in, proceed to the reservation page
            makeReservation();
        } else {
            // User is not logged in, show login dialog
            int response = JOptionPane.showConfirmDialog(this, "You need to log in to book a room. Would you like to log in now?", "Login Required", JOptionPane.YES_NO_OPTION);
    ...
    private void makeReservation() {
        ...
        // Redirect or open reservation page
        MakeReservations reservationPage = new MakeReservations();
    ...
    private void initComponents() {
        ...
        tblBookingroom = new rojeru_san.complementos.RSTableMetro();
        ...
        jPanel2.add(jLabel1);
        jLabel1.setBounds(330, 60, 640, 60);
        ...
        jPanel2.add(jLabel5);
        jLabel5.setBounds(570, 120, 620, 27);
        ...
        jButton3.setBackground(new java.awt.Color(160, 82, 45));
        jButton3.setFont(new java.awt.Font("Serif", 0, 18)); // NOI18N
        jButton3.setForeground(new java.awt.Color(255, 255, 255));
        jButton3.setText(" Show All Available Rooms");
        jButton3.setBorder(javax.swing.BorderFactory.createMatteBorder(1, 1, 1, 1, new java.awt.Color(78, 52, 46)));
        jButton3.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton3ActionPerformed(evt);
            }
        });
        jPanel4.add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(1052, 19, 234, 42));
        ...
        tblBookingroom.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        tblBookingroom.setColorBackgoundHead(new java.awt.Color(51, 0, 0));
        tblBookingroom.setColorFilasBackgound2(new java.awt.Color(139, 69, 19));
        tblBookingroom.setColorFilasForeground1(new java.awt.Color(0, 0, 0));
        tblBookingroom.setColorFilasForeground2(new java.awt.Color(0, 0, 0));
        tblBookingroom.setColorSelBackgound(new java.awt.Color(0, 0, 0));
        tblBookingroom.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        tblBookingroom.setFuenteFilas(new java.awt.Font("Serif", 1, 18)); // NOI18N
        tblBookingroom.setFuenteHead(new java.awt.Font("Stencil", 0, 18)); // NOI18N
        tblBookingroom.setRowHeight(25);
        jScrollPane1.setViewportView(tblBookingroom);

        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 360, 930, 350));
        ...
        jPanel1.add(booknowbtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(1080, 660, 190, 50));
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
          // Clear the table
        DefaultTableModel model = (DefaultTableModel) tblBookingroom.getModel();
        model.setRowCount(0);

        // Query database and populate table
        try (
                Connection con = DBConnection.getConnection(); PreparedStatement stmt = con.prepareStatement("SELECT * FROM rooms_notlogin WHERE availability_status = 'Available'")) {
    ...
    private void resetbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_resetbtnActionPerformed
        ...
        try (Connection con = DBConnection.getConnection(); PreparedStatement stmt = con.prepareStatement("SELECT * FROM rooms_notlogin")) {
            ResultSet rs = stmt.executeQuery();
    ...
    private void SearchbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SearchbtnActionPerformed
        // TODO add your handling code here:
         if (validateRoomType()) {
            ...
            // Query database and populate table
            try (
                    Connection con = DBConnection.getConnection(); PreparedStatement stmt = con.prepareStatement("SELECT * FROM rooms_notlogin WHERE room_type = ? AND availability_status = 'Available'")) {
    ...
    private rojeru_san.complementos.RSTableMetro tblBookingroom;
